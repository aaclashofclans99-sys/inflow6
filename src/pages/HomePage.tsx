            ...
            <div className="overflow-hidden">
              <div className="flex animate-scroll">
                ...
                <div className="flex items-center gap-12 min-w-max">
                  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/facebook/facebook-original.svg" alt="Facebook" className="h-12 w-auto" loading="lazy" />
                  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg" alt="Google" className="h-12 w-auto" loading="lazy" />
                  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg" alt="LinkedIn" className="h-12 w-auto" loading="lazy" />
                  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/slack/slack-original.svg" alt="Slack" className="h-12 w-auto" loading="lazy" />
                  ...
                  <svg className="h-12 w-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="logo-carousel w-full bg-white py-6 overflow-hidden">
        ...
        <div className="carousel-wrapper relative w-full overflow-hidden">
          <div className="carousel-track flex gap-12 animate-scroll">
            {/* Logo images start */}
            <img src="/logo carousel integrations/facebook.png" alt="Facebook" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/google.png" alt="Google" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/linkedin.png" alt="LinkedIn" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/slack.png" alt="Slack" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/instagram.png" alt="Instagram" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/printful.png" alt="Printful" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/xero.png" alt="Xero" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/zapier.png" alt="Zapier" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/whatsapp.png" alt="WhatsApp" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/stripe.png" alt="Stripe" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/tiktok.png" alt="TikTok" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/shopify.png" alt="Shopify" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/quickbooks.png" alt="QuickBooks" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/clio.png" alt="Clio" className="h-10 object-contain" loading="lazy" />
            <img src="/logo carousel integrations/shippo.png" alt="Shippo" className="h-10 object-contain" loading="lazy" />
